...
$(foreach inc, $(ALL_HEADER), $(eval$(call copy_file_rule, $(inc), $(BUILD_INC_PATH))))

## 调用哪个模块mk,就编译哪个模块。也可以同时将多个模块导入
ifneq "$(SHOT_MODULE)" ""
$(foreach build,$(SHOT_MODULE),$(eval -include $(build)))
$(error, 111111 $(SHOT_MODULE))
#include $(SHOT_MODULE)
else
#include src/hello/module.mk src/main/module.mk 
endif
