###########################################################################
## Makefile generated for Simulink model 'SRR_Driver_Fcn_20ms'. 
## 
## Makefile     : SRR_Driver_Fcn_20ms.mk
## Generated on : Tue May 09 19:37:07 2017
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SRR_Driver_Fcn_20ms.exe
...
PRODUCT_NAME              = SRR_Driver_Fcn_20ms
MAKEFILE                  = SRR_Driver_Fcn_20ms.mk
COMPUTER                  = PCWIN
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = SRR_Driver_Fcn_20ms_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = SRR_Driver_Fcn_20ms_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SRR_Driver_Fcn_20ms.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=SRR_Driver_Fcn_20ms -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw/SRR_Driver_Fcn_20ms.c $(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw/SRR_Driver_Fcn_20ms_data.c $(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw/rtGetInf.c $(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw/rtGetNaN.c $(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw/ert_main.c
...
OBJS = SRR_Driver_Fcn_20ms.obj SRR_Driver_Fcn_20ms_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/SRR_Driver_Fcn_20ms_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
