...
#ifndef RTW_HEADER_RFSRR_DataGen_Fcn_h_
#define RTW_HEADER_RFSRR_DataGen_Fcn_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef RFSRR_DataGen_Fcn_COMMON_INCLUDES_
# define RFSRR_DataGen_Fcn_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* RFSRR_DataGen_Fcn_COMMON_INCLUDES_ */

#include "RFSRR_DataGen_Fcn_types.h"
...
typedef struct {
  ...
  real_T EN_h;                         /* '<S56>/E->N' */
  real_T EN_j;                         /* '<S55>/E->N' */
  real_T RFSRR_Output[50];             /* '<Root>/Chart' */
  real_T RFSRR_RxTime_Out;             /* '<Root>/Chart' */
  real_T Side_Trigger_RFSRR_l;         /* '<Root>/Chart' */
  real_T range;                        /* '<Root>/Chart' */
  real_T azimuth;                      /* '<Root>/Chart' */
  real_T W;                            /* '<Root>/Chart' */
  real_T L;                            /* '<Root>/Chart' */
  real_T InstallAngRFSRR;              /* '<Root>/Chart' */
  real_T Add_i;                        /* '<S58>/Add' */
  ...
  real_T Add3;                         /* '<S58>/Add3' */
  uint16_T NE_bw;                      /* '<S4>/N->E' */
  int8_T RFSRR_Trig;                   /* '<Root>/Chart' */
...
} B_RFSRR_DataGen_Fcn_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  boolean_T Memory_PreviousInput;      /* '<S57>/Memory' */
} DW_RFSRR_DataGen_Fcn_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Chart_Trig_ZCE;           /* '<Root>/Chart' */
} PrevZCX_RFSRR_DataGen_Fcn_T;

/* Parameters (auto storage) */
struct P_RFSRR_DataGen_Fcn_T_ {
  ...
  real_T Gain_Gain;                    /* Expression: 0.5
                                        ...
                                        */
  real_T RF_SRR_Y_offsetm_Value;       /* Expression: 0.25
                                        * Referenced by: '<S58>/RF_SRR_Y_offset[m]'
                                        */
  real_T RF_SRR_Xoffsetm_Value;        /* Expression: -0.25
                                        * Referenced by: '<S58>/RF_SRR_Xoffset[m]'
                                        */
...
struct tag_RTM_RFSRR_DataGen_Fcn_T {
  const char_T * volatile errorStatus;
};

/* Block parameters (auto storage) */
extern P_RFSRR_DataGen_Fcn_T RFSRR_DataGen_Fcn_P;

/* Block signals (auto storage) */
extern B_RFSRR_DataGen_Fcn_T RFSRR_DataGen_Fcn_B;

/* Block states (auto storage) */
extern DW_RFSRR_DataGen_Fcn_T RFSRR_DataGen_Fcn_DW;

/* Model entry point functions */
extern void RFSRR_DataGen_Fcn_initialize(void);
extern void RFSRR_DataGen_Fcn_step(void);
extern void RFSRR_DataGen_Fcn_terminate(void);

/* Real-time Model object */
extern RT_MODEL_RFSRR_DataGen_Fcn_T *const RFSRR_DataGen_Fcn_M;
 ...
 *
 * '<Root>' : 'RFSRR_DataGen_Fcn'
 * '<S1>'   : 'RFSRR_DataGen_Fcn/Chart'
 * '<S2>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RFSRR_Data[10X5]'
 * '<S3>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RFSRR_RxTime'
 * '<S4>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RFSRR_Trigger'
 * '<S5>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth1'
 * '<S6>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth10'
 * '<S7>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth2'
 * '<S8>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth3'
 * '<S9>'   : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth4'
 * '<S10>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth5'
 * '<S11>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth6'
 * '<S12>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth7'
 * '<S13>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth8'
 * '<S14>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkAzimuth9'
 * '<S15>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp1'
 * '<S16>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp10'
 * '<S17>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp2'
 * '<S18>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp3'
 * '<S19>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp4'
 * '<S20>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp5'
 * '<S21>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp6'
 * '<S22>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp7'
 * '<S23>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp8'
 * '<S24>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkDynamProp9'
 * '<S25>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID1'
 * '<S26>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID10'
 * '<S27>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID2'
 * '<S28>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID3'
 * '<S29>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID4'
 * '<S30>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID5'
 * '<S31>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID6'
 * '<S32>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID7'
 * '<S33>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID8'
 * '<S34>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkObjID9'
 * '<S35>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate1'
 * '<S36>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate10'
 * '<S37>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate2'
 * '<S38>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate3'
 * '<S39>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate4'
 * '<S40>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate5'
 * '<S41>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate6'
 * '<S42>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate7'
 * '<S43>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate8'
 * '<S44>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRRate9'
 * '<S45>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange1'
 * '<S46>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange10'
 * '<S47>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange2'
 * '<S48>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange3'
 * '<S49>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange4'
 * '<S50>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange5'
 * '<S51>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange6'
 * '<S52>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange7'
 * '<S53>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange8'
 * '<S54>'  : 'RFSRR_DataGen_Fcn/Data_Cov_RF_SrrTrkRange9'
 * '<S55>'  : 'RFSRR_DataGen_Fcn/Data_Cov_Side_RFSRR_RxTime'
 * '<S56>'  : 'RFSRR_DataGen_Fcn/Data_Cov_Side_Trigger_RFSRR'
 * '<S57>'  : 'RFSRR_DataGen_Fcn/Trigger_Gen'
 * '<S58>'  : 'RFSRR_DataGen_Fcn/Chart/TemporalAligRF'
 * '<S59>'  : 'RFSRR_DataGen_Fcn/Trigger_Gen/Compare To Constant'
 */
#endif                                 /* RTW_HEADER_RFSRR_DataGen_Fcn_h_ */
