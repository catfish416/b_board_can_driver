###########################################################################
## Makefile generated for Simulink model 'LFSRR_DataGen_Fcn'. 
## 
## Makefile     : LFSRR_DataGen_Fcn.mk
## Generated on : Mon May 08 19:03:38 2017
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LFSRR_DataGen_Fcn.exe
...
PRODUCT_NAME              = LFSRR_DataGen_Fcn
MAKEFILE                  = LFSRR_DataGen_Fcn.mk
COMPUTER                  = PCWIN
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = LFSRR_DataGen_Fcn_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = LFSRR_DataGen_Fcn_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LFSRR_DataGen_Fcn.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=LFSRR_DataGen_Fcn -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw/LFSRR_DataGen_Fcn.c $(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw/LFSRR_DataGen_Fcn_data.c $(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw/rtGetInf.c $(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw/rtGetNaN.c $(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw/ert_main.c
...
OBJS = LFSRR_DataGen_Fcn.obj LFSRR_DataGen_Fcn_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/LFSRR_DataGen_Fcn_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
