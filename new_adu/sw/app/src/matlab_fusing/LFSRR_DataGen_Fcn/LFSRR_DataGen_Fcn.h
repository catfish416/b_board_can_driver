...
#ifndef RTW_HEADER_LFSRR_DataGen_Fcn_h_
#define RTW_HEADER_LFSRR_DataGen_Fcn_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef LFSRR_DataGen_Fcn_COMMON_INCLUDES_
# define LFSRR_DataGen_Fcn_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* LFSRR_DataGen_Fcn_COMMON_INCLUDES_ */

#include "LFSRR_DataGen_Fcn_types.h"
...
typedef struct {
  ...
  real_T EN_h;                         /* '<S56>/E->N' */
  real_T EN_j;                         /* '<S55>/E->N' */
  real_T LFSRR_Output[50];             /* '<Root>/Chart' */
  real_T LFSRR_RxTime_Out;             /* '<Root>/Chart' */
  real_T Side_Trigger_LFSRR_b;         /* '<Root>/Chart' */
  real_T range;                        /* '<Root>/Chart' */
  real_T azimuth;                      /* '<Root>/Chart' */
  real_T W;                            /* '<Root>/Chart' */
  real_T L;                            /* '<Root>/Chart' */
  real_T InstallAngLFSRR;              /* '<Root>/Chart' */
  real_T Add_l;                        /* '<S58>/Add' */
...
} B_LFSRR_DataGen_Fcn_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  boolean_T Memory_PreviousInput;      /* '<S57>/Memory' */
} DW_LFSRR_DataGen_Fcn_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Chart_Trig_ZCE;           /* '<Root>/Chart' */
} PrevZCX_LFSRR_DataGen_Fcn_T;

/* Parameters (auto storage) */
struct P_LFSRR_DataGen_Fcn_T_ {
  ...
  real_T Gain_Gain;                    /* Expression: 0.5
                                        ...
                                        */
  real_T LF_SRR_Y_offsetm_Value;       /* Expression: -0.25
                                        * Referenced by: '<S58>/LF_SRR_Y_offset[m]'
                                        */
  real_T LF_SRR_Xoffsetm_Value;        /* Expression: -0.25
                                        * Referenced by: '<S58>/LF_SRR_Xoffset[m]'
                                        */
...
struct tag_RTM_LFSRR_DataGen_Fcn_T {
  const char_T * volatile errorStatus;
};

/* Block parameters (auto storage) */
extern P_LFSRR_DataGen_Fcn_T LFSRR_DataGen_Fcn_P;

/* Block signals (auto storage) */
extern B_LFSRR_DataGen_Fcn_T LFSRR_DataGen_Fcn_B;

/* Block states (auto storage) */
extern DW_LFSRR_DataGen_Fcn_T LFSRR_DataGen_Fcn_DW;

/* Model entry point functions */
extern void LFSRR_DataGen_Fcn_initialize(void);
extern void LFSRR_DataGen_Fcn_step(void);
extern void LFSRR_DataGen_Fcn_terminate(void);

/* Real-time Model object */
extern RT_MODEL_LFSRR_DataGen_Fcn_T *const LFSRR_DataGen_Fcn_M;
 ...
 *
 * '<Root>' : 'LFSRR_DataGen_Fcn'
 * '<S1>'   : 'LFSRR_DataGen_Fcn/Chart'
 * '<S2>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LFSRR_Data[10X5]'
 * '<S3>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LFSRR_RxTime'
 * '<S4>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LFSRR_Trigger'
 * '<S5>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth1'
 * '<S6>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth10'
 * '<S7>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth2'
 * '<S8>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth3'
 * '<S9>'   : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth4'
 * '<S10>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth5'
 * '<S11>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth6'
 * '<S12>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth7'
 * '<S13>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth8'
 * '<S14>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkAzimuth9'
 * '<S15>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp1'
 * '<S16>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp10'
 * '<S17>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp2'
 * '<S18>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp3'
 * '<S19>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp4'
 * '<S20>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp5'
 * '<S21>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp6'
 * '<S22>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp7'
 * '<S23>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp8'
 * '<S24>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkDynamProp9'
 * '<S25>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID1'
 * '<S26>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID10'
 * '<S27>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID2'
 * '<S28>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID3'
 * '<S29>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID4'
 * '<S30>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID5'
 * '<S31>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID6'
 * '<S32>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID7'
 * '<S33>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID8'
 * '<S34>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkObjID9'
 * '<S35>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate1'
 * '<S36>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate10'
 * '<S37>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate2'
 * '<S38>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate3'
 * '<S39>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate4'
 * '<S40>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate5'
 * '<S41>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate6'
 * '<S42>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate7'
 * '<S43>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate8'
 * '<S44>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRRate9'
 * '<S45>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange1'
 * '<S46>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange10'
 * '<S47>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange2'
 * '<S48>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange3'
 * '<S49>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange4'
 * '<S50>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange5'
 * '<S51>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange6'
 * '<S52>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange7'
 * '<S53>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange8'
 * '<S54>'  : 'LFSRR_DataGen_Fcn/Data_Cov_LF_SrrTrkRange9'
 * '<S55>'  : 'LFSRR_DataGen_Fcn/Data_Cov_Side_LFSRR_RxTime'
 * '<S56>'  : 'LFSRR_DataGen_Fcn/Data_Cov_Side_Trigger_LFSRR'
 * '<S57>'  : 'LFSRR_DataGen_Fcn/Trigger_Gen'
 * '<S58>'  : 'LFSRR_DataGen_Fcn/Chart/TemporalAligLF'
 * '<S59>'  : 'LFSRR_DataGen_Fcn/Trigger_Gen/Compare To Constant'
 */
#endif                                 /* RTW_HEADER_LFSRR_DataGen_Fcn_h_ */
